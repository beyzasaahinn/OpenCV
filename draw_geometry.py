# geometrik şekillerin opencv kütüphanesindeki metotlarını kullanarak oluşturalım.
...
# şimdi de rastgele çizgiler ve dikdörtgenler oluşturarak ekrana bastıralım.
'''
bunun için şöyle bir gidiş yolu izlenebilir : 
bir for döngüsü açıp 100.000' kadar gidip her bir iterasyonda rastgele resim oluşturup değerlerini sıfıra eşitleyip
bunun üzerinden rastgele sayılar oluşturarak bir görsel oluşturabiliriz.
'''
